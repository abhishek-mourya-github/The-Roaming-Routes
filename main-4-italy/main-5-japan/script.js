gsap.from(".nav .nav-first a, .nav .nav-middle a, .nav .nav-last a", {
  ...
  gsap.from(
    ".page3 .container-5 .rightpart .serial-no-4 h1, .page3 .container-5 .rightpart .info-3 h1 ,.page3 .container-5 .rightpart .info-3 p, .page3 .container-5 .rightpart .info-3 a ",
    {
      x: 300,
      delay: 1,
      duration: 1.3,
